#!/bin/sh
#SBATCH -J Primates1_1         # The job name
...
#SBATCH -o o_primates1_1.txt         # The output file
#SBATCH -e e_primates1_1.txt         # The error file

module load beagle-lib/3.0.1-gimkl-2017a
module load Java/1.8.0_144

srun java -Xmx2800m -Djava.library.path=$BEAGLE_LIB_PATH -jar /nesi/project/nesi00390/rong/operator/ConstantDistanceOperator.jar -threads 8 -beagle_SSE /nesi/project/nesi00390/rong/operator/primates/xml/primates1_1.xml
