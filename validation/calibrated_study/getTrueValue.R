...
write.table(S1,file=paste0(output.txt.folder,taxa,"taxa/Fre1.txt"),col.name=F,row.names=F)
write.table(S2,file=paste0(output.txt.folder,taxa,"taxa/Fre2.txt"),col.name=F,row.names=F)
write.table(S3,file=paste0(output.txt.folder,taxa,"taxa/Fre3.txt"),col.name=F,row.names=F)
write.table(S4,file=paste0(output.txt.folder,taxa,"taxa/Fre4.txt"),col.name=F,row.names=F)
