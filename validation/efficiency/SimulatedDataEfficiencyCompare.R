...
boxplot(Short.Ratio.df, xlim = c(0,15), ylim=c(0,10), col="royalblue3", boxwex = 0.2, at = seq(0,15,length.out=14) - 0.2,outline=FALSE,xaxt="n",yaxt="n")
axis(1, at = seq(0,15,length.out=14), labels = colnames(Cons.Efficiency.df),las=2,cex.axis=0.8)
axis(2,cex.axis=0.8)
boxplot(Medium.Ratio.df, xlim = c(0,15), ylim=c(0,10),boxwex = 0.2, at = seq(0,15,length.out=14) + 0.2,col="mediumseagreen",outline=FALSE,xaxt="n",yaxt="n",add=TRUE)
